  ...
  return (
    <div className="space-y-6">
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-3 border border-border/50 rounded-lg py-2.5 px-4 hover:bg-primary/5 hover:border-primary/30 transition-colors font-sans text-sm text-foreground/70"
      >
        <svg
